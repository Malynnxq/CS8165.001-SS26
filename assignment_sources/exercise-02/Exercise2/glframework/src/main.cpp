...
std::vector<julia_vertex> createJuliaVertices()
{
    ...
    // vertices.push_back(julia_vertex{ glm::vec2(), glm::vec2() });
    // ...
...
int main()
{
    ...
    GLint zoomUniformLocation = -1;
    GLint zoomPositionUniformLocation = -1;
    ...
    // Question 2a
    // TODO: Get vertex attribute locations here...
    GLuint positionAttrib = -1;
    GLuint complexAttrib = -1;
    ...
    // glVertexAttribPointer(complexAttrib, ...);
    glBindVertexArray(0);
